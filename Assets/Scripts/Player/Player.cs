...
public class Player : NetworkBehaviour
{
    ...
    void Start()
    {
        ...
        if (isLocalPlayer)
        {
            StartCoroutine(ForceEnableTerrainDetails());
        }
    }


    System.Collections.IEnumerator ForceEnableTerrainDetails()
    {
        ...
        if (Terrain.activeTerrain != null)
        {
            ...
            Debug.Log($"[Player] 터레인 디테일 활성화 - Distance: {terrain.detailObjectDistance}, Density: {terrain.detailObjectDensity}");
        }
    }
